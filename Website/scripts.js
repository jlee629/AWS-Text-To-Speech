...
//const serverUrl = "https://jbm4ehmuua.execute-api.us-east-1.amazonaws.com/api";
...
function annotateImage(data) {
    ...
    data.translatedLines.forEach(translation => {
        ...
        audioElem.src = `data:audio/mp3;base64,${translation.audioBase64}`;
        translationsElem.appendChild(translationElem);
        translationsElem.appendChild(document.createElement("br"));
        translationsElem.appendChild(audioElem);
        translationsElem.appendChild(document.createElement("hr"));
    });
}
